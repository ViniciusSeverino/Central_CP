...
// pedido enquanto ainda pendente (arrependimento antes da aprovação).
...
checar(!!document.querySelector('[data-registrar-caixinha="caixinha-1"][data-tipo="reforco"]'), 'departamento vê o botão de registrar reforço');
...
// mov-2 (pendente, de outro usuário) não pode ser aprovada nem excluída
// por quem não é o dono e não tem autoridade de aprovação.
...
checar(!document.querySelector('[data-excluir-caixinha="mov-2"]'), 'departamento NÃO pode excluir uma movimentação pendente de outra pessoa');
